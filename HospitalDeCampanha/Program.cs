...
namespace HospitalDeCampanha
{
	class Program
	{
                        ...
                        case 6:
                            ...
                            do
                            {
                                ...
                                if (int.TryParse(Console.ReadLine(), out op2))
                                    ...
                                    if (op2 == 1)
                                    {
                                        ImprimeCSV("Arquivo Assintomatico", "\nAssintomaticos");
                                    }
                                    else if (op2 == 2)
                                    {
                                        ImprimeCSV("Arquivo Sintomatico", "\nSintomatico");
                                    }
                                    else if (op2 == 3)
                                    {
        ...
        static void ImprimeCSV(string file_name, string header)
        {
            string linha = "";
            string[] linhaseparada = null;
            string file_path = "C:\\Users\\Andressa\\source\\repos\\ArquivosCovid" + file_name + ".csv";
